			...
			<form>
				...
				<div className="form-group row">						
					<div className="offset-sm-2 col-sm-9">
						<textarea rows="10" className="form-control" onChange={(e) => this.setValue(e.target.value,"instructions")}  id="inputRecipeInstructions" value={this.props.recipe.instructions}></textarea>							
					</div>
				</div>		
				<div className="form-group row">
